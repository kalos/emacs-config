...
(defun bh/org-todo (arg)
  ...
  (if (equal arg 4)
      (save-restriction
        (bh/org-narrow-to-subtree)
        (org-show-todo-tree nil))
    (bh/org-narrow-to-org-subtree)
    (org-show-todo-tree nil)))
...
; force showing the next headline in f5 / S-f5
...
; NEXT is for tasks not for projects
...
; bakcup - saves all org buffers at 1 minute before the hour
